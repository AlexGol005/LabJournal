...
class ViscosityMJL(models.Model):
    ...
    kriteriy = models.DecimalField('Критерий приемлемости измерений', max_digits=4, decimal_places=2, null=True)
    ...
    Konstant2 = models.DecimalField('Константа вискозиметра № 2', max_digits=20, decimal_places=6, default='0',
                                    null=True, blank=True)
    plustimeminK1T1 = models.DecimalField('Время истечения K1T1, + мин', max_digits=3, decimal_places=0, null=True, blank=True)
    plustimesekK1T1 = models.DecimalField('Время истечения K1T1, + cек', max_digits=5, decimal_places=2, null=True, blank=True)
    plustimeminK1T2 = models.DecimalField('Время истечения K1T2, + мин', max_digits=3, decimal_places=0, null=True, blank=True)
    plustimesekK1T2 = models.DecimalField('Время истечения K1T2, + cек', max_digits=5, decimal_places=2, null=True, blank=True)
    plustimeminK2T1 = models.DecimalField('Время истечения K2T1, + мин', max_digits=3, decimal_places=0, null=True, blank=True)
    plustimesekK2T1 = models.DecimalField('Время истечения K2T1, + cек', max_digits=5, decimal_places=2, null=True, blank=True)
    plustimeminK2T2 = models.DecimalField('Время истечения K2T2, + мин', max_digits=3, decimal_places=0, null=True, blank=True)
    plustimesekK2T2 = models.DecimalField('Время истечения K2T2, + cек', max_digits=5, decimal_places=2, null=True, blank=True)
    ...
    # костыль для добавления секундомера и термометра и комнаты
        self.equipment1 = MeasurEquipment.objects.get(equipment__exnumber=timer)
        self.equipment4 = MeasurEquipment.objects.get(equipment__exnumber=termometer)
