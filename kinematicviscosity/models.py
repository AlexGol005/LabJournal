...
class ViscosityMJL(models.Model):
    ...
    viscosity1 = models.DecimalField('Вязкость кинематическая 1', max_digits=20, decimal_places=7, default=0.0000000, null=True)
    viscosity2 = models.DecimalField('Вязкость кинематическая 2', max_digits=20, decimal_places=7, default=0.0000000, null=True)
    viscosityAVG = models.DecimalField('Вязкость кинематическая среднее', max_digits=20, decimal_places=7, default=0.0000000, null=True)
