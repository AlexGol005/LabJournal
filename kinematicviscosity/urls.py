...
urlpatterns = [
    ...
    path('searchresultseria/', views.SearchResultSeriaView.as_view(), name=URL + 'searchseria'),
    ...
    path(r'^export1/xls/$/<int:pk>', views.export_protocol_xls_template_1, name='export_kinematicviscosity_protocol_xls'),
