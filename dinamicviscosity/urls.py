...
urlpatterns = [
    ...
    path('attestation/', login_required(views.AllStrView.as_view()), name='dinamicviscosityall'),
    ...
    path(r'^export1/xls/$/<int:pk>', views.export_protocol_xls_template_1, name='export_dinamicviscosity_protocol_xls'),
