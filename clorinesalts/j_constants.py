...
conclusionoptional = (
    ('Контроль стабильности партии удовлетворителен, так как расхождение между измеренным аттестованным значением содержания хлористых солей не превышает критерий К'),
