...
from kinematicviscosity.models import ViscosityMJL, CommentsKinematicviscosity
from kinematicviscosity.forms import StrJournalCreationForm, StrJournalUdateForm, CommentCreationForm
...
class HeadView(View):
    ...
    """Стандартная"""
    def __init__(self, JOURNAL, URL):
        super().__init__(JOURNAL, URL)
        self.JOURNAL = JOURNAL
        self.URL = URL

    def get(self, request, JOURNAL, URL):
        def set_target(self, JOURNAL):
            self.target = JOURNAL
