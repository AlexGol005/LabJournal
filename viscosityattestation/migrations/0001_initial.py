    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time12_sec', models.DecimalField(decimal_places=2, default='0', max_digits=6, verbose_name='Время истечения 11, в секундах')),
                ('time21_sec', models.DecimalField(decimal_places=2, default='0', max_digits=6, verbose_name='Время истечения 11, в секундах')),
                ('time22_sec', models.DecimalField(decimal_places=2, default='0', max_digits=6, verbose_name='Время истечения 11, в секундах')),
                ...
                ('viscosity1', models.DecimalField(decimal_places=6, default='0', max_digits=20, verbose_name='Вязкость кинематическая 1')),
                ('viscosity2', models.DecimalField(decimal_places=6, default='0', max_digits=20, verbose_name='Вязкость кинематическая 2')),
