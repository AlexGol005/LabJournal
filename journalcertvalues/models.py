...
class LotVG(models.Model):
    nameVG = models.ForeignKey(VG, verbose_name='СО', max_length=100, on_delete=models.PROTECT, default='')
    lot = models.CharField('Партия', max_length=5)
    person = models.ForeignKey(User, verbose_name='Изготовил', max_length=30,  on_delete=models.PROTECT, default='')
    date = models.DateField('Дата изготовления', max_length=30, default='2000-11-11')
